...
interface CIP30 {
  ...
  getRewardAddresses(): Promise<(typeof Address)[]>;
  getUnusedAddresses(): Promise<(typeof Address)[]>;
  getUsedAddresses(): Promise<(typeof Address)[]>;
  getChangeAddress(): Promise<typeof Address>;
  getUtxos(): Promise<any[]>;
  signData(address: typeof Address, payload: string): Promise<any>;
  signTx(): Promise<any>;
