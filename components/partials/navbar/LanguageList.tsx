...
export default function LanguageList() {
  ...
  return (
    <Combobox as="div" value={selectedPerson} onChange={setSelectedPerson}>
      <div className="relative mt-2 text-base xl:text-xl">
        <Combobox.Input
          className="w-full rounded-2xl small-component-color border-0 border-transparent outline-none focus:outline-[#3DFFDC] py-4 pl-4 pr-10 text-base xl:text-xl text-white shadow-sm sm:leading-6"
