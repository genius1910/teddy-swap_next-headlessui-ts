        ...
        <div className="w-full ">
          ...
          <div className="relative bg-[#2A3240] flex w-full sm:w-auto items-center rounded-lg">
            ...
            <input
              ...
              className=" placeholder:text-[#8E8E8E] text-[12px] leading-[14px] font-medium w-full h-full py-[12px] pl-2 pr-4 bg-transparent outline-none rounded-[5px]g"
            />
          </div>
        </div>
            ...
            {query == "" ? (
                ...
                return (
                  <>
                    ...
                    <tr>
                        ...
                        <span className="flex items-center gap-3 justify-start ml-2">
                          <span className="gap-1 w-max flex items-center py-1.5 rounded-lg">
                            <Image
                              ...
                              alt="Token"
                            />
                            <p className="text-[14px] leading-[16px] font-medium ml-[5px]">
                      ...
                      <td className="px-10 py-3 text-[14px] leading-[16px] font-medium">
                        {item.type}
                      </td>
                      <td className="px-10  py-3 text-[14px] leading-[16px] font-medium">
                      ...
                      <td className="px-10 py-3 gap-1 text-sm xl:text-base">
                        <span className="flex items-center text-[14px] leading-[16px] font-medium ">
                          {" "}
              ...
              <tr>
                <td colSpan={5} rowSpan={6} className="mx-auto w-full py-6 ">
                  ...
                  <button className="py-3 px-20 primary-button rounded-2xl text-lg xl:text-xl w-72">
                    Swap
                  </button>
                </td>
              </tr>
