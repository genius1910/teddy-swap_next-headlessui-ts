    ...
    return (
        <div className="w-full mt-10 component-color rounded-lg px-4 sm:px-8 py-6 ">
            ...
            <div className="flex justify-between relative ">
                <div>
                    <h4 className="mb-2">Search by token</h4>
                    <div className="relative mid-s-component-color flex w-full  sm:w-auto items-center rounded-lg">
                        ...
                        <input
                            ...
                            className=" placeholder:text-gray-400 text-sm w-full sm:w-96 h-full p-[1.05rem] bg-transparent outline-none rounded-lg"
                        />
                    </div>
                </div>
                <div>
                    <h4 className="mb-2">Search by Action</h4>
                    <div className="relative mid-s-component-color flex w-full sm:w-auto items-center rounded-lg">
                        <select name="actions" id="actions" className=" placeholder:text-gray-400 text-sm w-full sm:w-96 p-4 bg-transparent outline-none rounded-lg">
                            <option className=" bg-gray-800" value="All">All</option>
                            <option className=" bg-gray-800" value="Swap">Swap</option>
                            <option className=" bg-gray-800" value="Deposit">Deposit</option>
                            <option className=" bg-gray-800" value="Withdraw">Withdraw</option>
                        </select>
                    </div>
                </div>
                <div>
                    <h4 className="mb-2">Search by Status</h4>
                    <div className="relative mid-s-component-color flex w-full sm:w-auto items-center rounded-lg">
                        <select name="actions" id="actions" className=" placeholder:text-gray-400 text-sm w-full sm:w-96 p-4 bg-transparent outline-none rounded-lg">
                            <option className=" bg-gray-800" value="All">All</option>
                            <option className=" bg-gray-800" value="Complete">Complete</option>
                            <option className=" bg-gray-800" value="Pending">Pending</option>
                            <option className=" bg-gray-800" value="Canceled">Canceled</option>
                        </select>
                    </div>
                </div>
            </div>
                    ...
                    {query == "" ? [1, 2, 3, 4, 5].map((item) => {
                                                ...
                                                <>
                                                    ...
                                                    >
                                                        <Popover.Panel className="absolute outline-none small-component-color text-gray-300 rounded-2xl -top-8 right-5 z-50 mt-8 transform max-w-sm 2xl:max-w-md">
                                                            {({ close }) => <div className=" p-3 rounded-xl text-xs font-normal flex flex-col items-start justify-start w-full gap-2">
                        ...
                        <tr>
                            <td colSpan={5} rowSpan={6} className="mx-auto w-full py-6 ">
                                ...
                                <button className="py-4 px-20 primary-button rounded-2xl text-lg 2xl:text-xl w-72">Swap</button>
                            </td>
                        </tr>
                    </tbody>}
                </table>
