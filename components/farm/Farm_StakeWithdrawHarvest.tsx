                    ...
                    <div className="flex items-center justify-between w-full">
                        <div className="flex gap-4">
                            <button
                                ...
                                className={`${currentTab == "stake" ? "text-gray-100" : "text-gray-400"
                            ...
                            <button
                                ...
                                className={`${currentTab == "withdraw" ? "text-gray-100" : "text-gray-400"
                                    } text-base 2xl:text-xl font-medium`}
                            >
                                Withdraw
                            </button>
                            <button
                                ...
                                className={`${currentTab == "harvest" ? "text-gray-100" : "text-gray-400"
                                    } text-base 2xl:text-xl font-medium`}
                            >
                                Harvest
                            </button>
