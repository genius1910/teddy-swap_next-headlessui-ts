...
const Dash_Section5 = () => {
  return (
    <section id="dash-section-5">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-14 lg:gap-28 text-base xl:text-2xl items-center py-32 md:py-44 xl:py-60 ">
        ...
        <div className=" col-span-1 lg:col-span-2 flex flex-col gap-7 xl:gap-10 lg:pl-10">
