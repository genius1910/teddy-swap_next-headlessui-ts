        ...
        <table className="tbody-b-remove w-full">
          ...
          {[1, 2, 3, 4, 5].map((item, index) => {
            return (
              <tbody
                key={item}
                className=" hover:bg-[#D9D9D9]/10 cursor-pointer rounded-lg transition-all duration-150 ease-in-out"
              >
                <tr>
                  ...
                  <td className="px-10 pl-4 py-4">
                    <span className="flex items-center gap-1.5">
                      <Image
                        ...
                        className="-ml-3"
                      />
                      <h4 className="text-base font-medium">TEDY</h4>
                  ...
                  <td className="px-10 py-4  gap-1 text-base text-[#2CC696]">
