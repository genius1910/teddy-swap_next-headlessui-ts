    ...
    <Fragment>
      <tbody>
        <tr
          ...
          className={`${showDetails && "border-b-0 bg-black/10 mb-20"
            } cursor-pointer`}
        >
        ...
        {showDetails && (
          <tr>
            <td colSpan={9} className=" border-t-0 bg-black/10 w-full overflow-hidden">
              <span className="flex justify-between">
                <p className="px-6 py-4 flex flex-col gap-1 text-base">
                  <span className=" text-gray-400">Price:</span>
                  <span>
                    <span className=" text-gray-300 text-sm">1 ADA = 10.4545 TEDDY</span>
                    <br />
                    <span className=" text-gray-300 text-sm">1 TEDY = 0.19903 ADA</span>
                  </span>
                </p>
                <p className="px-6 py-4 flex flex-col gap-1 text-base">
                  <span className=" text-gray-400">Total Liquidity:</span>
                  <span>
                    <span className=" text-gray-300 text-sm">ADA: 26,747,918</span>
                    <br />
                    <span className=" text-gray-300 text-sm">TEDY: 134,384,920</span>
                  </span>
                </p>
                <p className="px-6 py-4 flex flex-col gap-1 text-base">
                ...
                <p className="px-6 py-4 flex flex-col gap-1 text-base">
                  <span>
                    <span className=" text-gray-400">Volatility Index (1M):</span>
                    <br />
                ...
                <p className="px-6 py-4 flex gap-4 text-base items-start my-auto translate-y-2/6">
                  <button className="third-button w-52 p-2.5 font-medium">Swap</button>
